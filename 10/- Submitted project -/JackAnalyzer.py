class Main(object):
    ...
    def __init__(self, file_or_dir_path):
        ...
        for filename in files_to_compile :
            ...
            self.compilation_engine_magic(jack_file_path, tokenizer_output_filename)
    ...
    def compilation_engine_magic(self, jack_file_path, tokenizer_output_filename):

        compilation_engine = CompilationEngine(tokenizer_output_filename)

        compilation_engine.open_compilation_engine_xml_file(jack_file_path)
        compilation_engine.compile_class()
        compilation_engine.close_compilation_engine_xml_file()
